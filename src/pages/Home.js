...
function Home(){
    ...
    return (
        ...
        <div className="w-full flex justify-center  bg-slate-50 relative">
            <section className="fixed  w-full top-0 left-0 right-0 z-10 bg-slate-50">
                ...
                <div className="flex justify-between w-full p-2 mt-5 h-max content-center   mr-auto ml-auto lg:w-4/5">
                    ...
                    <div className="w-2/6 flex justify-between content-center items-center text-center mt-5 ">
            ...
            <section className=" mt-48 w-full h-max  bg-white mr-auto ml-auto lg:w-4/5">
                    ...
                    <div className="">
                        ...
                        {data &&
                            data.map(({ id, type,company, title }) => (
                                <Job key={id} type={type}name={title} company={company} jobsId={id}/>
                        ))}
                    </div>
                </div>
